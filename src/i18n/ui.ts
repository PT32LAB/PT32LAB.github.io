...
export const ui = {
  en: {
    ...
    'hero.subtitle': 'An off-grid community in the Bolivian Yungas — techno park, startup incubator, trading house, and technoshamanic retreat center — blending indigenous wisdom with modern practice. Semi-autonomous. Open-source. Human-first.',
